...
export const useZzzAchievementStore = defineStore('zzzAchievements', ()=> {
    ...
    async function getAchievementsByClassId(classId) {
    ...
    return { fetchAchievements, getAchievementsByClassId, completeAchievement };
})
